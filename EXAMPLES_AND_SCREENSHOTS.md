# ncurses-java: Examples & Screenshots

Complete showcase of the ncurses-java terminal UI library with real working examples and screenshots.

---

## 📋 Table of Contents

1. [Professional Applications](#professional-applications)
   - [Todo List Manager](#todo-list-manager)
   - [System Monitor Dashboard](#system-monitor-dashboard)
2. [Component Demos](#component-demos)
   - [Simple Interactive Demo](#simple-interactive-demo)
   - [All Widgets Showcase](#all-widgets-showcase)
   - [Table Component Test](#table-component-test)
...
```bash
# 1. Install ncurses development library
# Ubuntu/Debian:
...
# 2. Clone and build
git clone https://github.com/FlossWare/ncurses-java.git
cd ncurses-java
mvn clean compile
```
...
```bash
# Compile examples
javac --enable-preview --release 21 -cp target/classes -d examples examples/*.java
...
| **Arrow Keys** | Navigate (in supported components) |
...
- Issues: https://github.com/FlossWare/ncurses-java/issues
- Docs: See `README.md`
- Tests: See `COMPLETE_UI_TEST_RESULTS.md`
