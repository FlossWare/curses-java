package org.flossware.jcurses.api.layouts;
...
@DisplayName("JGridLayout Tests")
class JGridLayoutTest {
    private Container container;
    private JGridLayout layout;
