...
import org.flossware.jcurses.api.JSlider;
...
@DisplayName("JSlider Tests")
class JSliderTest extends ComponentTestBase {
    ...
    void testCustomInitialization() {
        JSlider customSlider = new JSlider(0, 200, 100);
    ...
    void testCustomRange() {
        JSlider customSlider = new JSlider(10, 50, 30);
