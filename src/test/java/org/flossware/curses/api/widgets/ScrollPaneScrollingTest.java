...
import org.flossware.curses.api.ScrollPane;
...
@DisplayName("ScrollPane Scrolling Tests")
class ScrollPaneScrollingTest extends ComponentTestBase {
    ...
    void testEmptyScrollPane() {
        ScrollPane emptyPane = new ScrollPane();
