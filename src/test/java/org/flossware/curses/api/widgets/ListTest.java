...
import org.flossware.curses.api.ListComponent;
...
@DisplayName("ListComponent Tests")
class ListTest extends ComponentTestBase {
    private ListComponent widget;

    @BeforeEach
    void setUp() {
        widget = new ListComponent();
        widget.setSize(20, 5);
