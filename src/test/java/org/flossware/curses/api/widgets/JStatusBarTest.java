...
import org.flossware.curses.api.JStatusBar;
...
@DisplayName("JStatusBar Tests")
class JStatusBarTest extends ComponentTestBase {
    private JStatusBar widget;

    @BeforeEach
    void setUp() {
        widget = new JStatusBar();
        widget.setSize(20, 1);
    ...
    void testCreationWithText() {
        JStatusBar statusBar = new JStatusBar("Ready");
