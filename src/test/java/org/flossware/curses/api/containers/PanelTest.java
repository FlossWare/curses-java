...
import org.flossware.curses.api.FlowLayout;
import org.flossware.curses.api.Label;
import org.flossware.curses.api.Panel;
...
class PanelTest extends ComponentTestBase {
    private Panel panel;
    ...
    void testCreationWithLayout() {
        ...
        Panel panelWithLayout = new Panel(layout);
