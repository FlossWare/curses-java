package org.flossware.curses.api.containers;

import org.flossware.curses.api.DraggableWindow;
import org.flossware.curses.api.Frame;
...
@DisplayName("Frame Tests")
class FrameTest extends ComponentTestBase {
    private Frame frame;
    ...
    void testDraggableWindowDefaults() {
        // Test that Frame implements DraggableWindow and can use default methods
